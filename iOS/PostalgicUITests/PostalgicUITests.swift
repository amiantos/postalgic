...
final class PostalgicUITests: XCTestCase {
    ...
    func testCreateAndViewPost() throws {
        ...
        contentTextEditor.typeText(
            "This is the content of my test post with some **bold** formatting."
        )
        ...
        XCTAssertTrue(
            app.links["https://example.com/article"].exists
        ...
        XCTAssertTrue(
            app.staticTexts.matching(
                NSPredicate(format: "label CONTAINS 'This is the content'")
            ).firstMatch.exists
        )
    }
    ...
    func testDeleteBlog() throws {
        ...
        let cell = app.cells.containing(.staticText, identifier: "Test Blog")
            .element
