...
open class Log {
    ...
    private static func log(_ object: @autoclosure () -> some Any, level: Log.Level,
    ...
    public static func error(_ object: @autoclosure () -> some Any,
    ...
    public static func warn(_ object: @autoclosure () -> some Any,
                           _ fileName: String = #file,
                           _ functionName: String = #function,
                           _ line: Int = #line) {
    ...
    public static func info(_ object: @autoclosure () -> some Any,
                           _ fileName: String = #file,
                           _ functionName: String = #function,
                           _ line: Int = #line) {
    ...
    public static func debug(_ object: @autoclosure () -> some Any,
                            _ fileName: String = #file,
                            _ functionName: String = #function,
                            _ line: Int = #line) {
    ...
    public static func verbose(_ object: @autoclosure () -> some Any,
                              _ fileName: String = #file,
                              _ functionName: String = #function,
                              _ line: Int = #line) {
