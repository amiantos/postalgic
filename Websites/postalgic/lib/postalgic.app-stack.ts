...
export class PostalgicAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const DOMAIN_NAME = "postalgic.app";
    ...
    const certificateArn =
      "arn:aws:acm:us-east-1:341089094749:certificate/1750b79d-d5fb-452d-9e7c-823b62b25bf4";
