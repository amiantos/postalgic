  ...
  <div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-gray-500 text-sm">{{ blogStore.tags.length }} tags</p>
      </div>
      <button
    ...
    <!-- Empty State -->
    <div v-if="blogStore.tags.length === 0" class="text-center py-12 bg-white rounded-lg border border-gray-200">
      ...
      <p class="text-gray-500 mb-6">Create tags to organize your posts.</p>
      <button
        @click="openCreateModal"
    ...
    <div v-else class="flex flex-wrap gap-3">
      <div
        ...
        :key="tag.id"
        class="bg-white rounded-lg border border-gray-200 px-4 py-2 flex items-center gap-3"
      >
      ...
      <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div>
          ...
          <input
            ...
            @keyup.enter="saveTag"
          />
          <p class="mt-1 text-sm text-gray-500">Tags are automatically lowercased</p>
        </div>
