...
<template>
  <div class="p-6 max-w-4xl">
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-xl font-bold text-gray-900">Themes</h2>
      <button
    ...
    <div v-else class="space-y-3">
      <div
        ...
        :class="[
          ...
          selectedThemeId === theme.id ? 'border-primary-500 ring-1 ring-primary-500' : 'border-gray-200'
        ]"
      >
        <div class="flex items-center justify-between">
            ...
            >
              <div
                :class="[
                  ...
                  selectedThemeId === theme.id ? 'border-primary-600' : 'border-gray-300'
                ]"
              >
                <div
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              ...
              class="px-3 py-1.5 text-gray-700 hover:bg-gray-100 rounded-lg text-sm flex items-center gap-1"
            >
    ...
    <div
      ...
      class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    >
      <div class="bg-white rounded-lg max-w-6xl w-full mx-4 h-[90vh] flex flex-col">
        <!-- Header -->
        ...
        <div class="flex-1 flex overflow-hidden">
          ...
          <div class="w-64 border-r border-gray-200 overflow-y-auto">
            <div class="p-4">
              <h4 class="text-sm font-medium text-gray-700 mb-2">Templates</h4>
              <div class="space-y-1">
                <button
          ...
          <div class="flex-1 flex flex-col">
            <div v-if="editingTemplateName" class="flex-1 flex flex-col">
              <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                <h4 class="font-medium text-gray-900">{{ editingTemplateName }}</h4>
                <button
                  @click="saveTemplate"
              ...
              <div class="flex-1 p-4">
                <textarea
                  ...
                  class="w-full h-full font-mono text-sm border border-gray-300 rounded-lg p-3 resize-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  spellcheck="false"
                ></textarea>
              </div>
            </div>
