  ...
  <div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-gray-500 text-sm">{{ blogStore.categories.length }} categories</p>
      </div>
      <button
    ...
    <!-- Empty State -->
    <div v-if="blogStore.categories.length === 0" class="text-center py-12 bg-white rounded-lg border border-gray-200">
      ...
      <p class="text-gray-500 mb-6">Create categories to organize your posts.</p>
      <button
        @click="openCreateModal"
