...
<template>
  <div class="p-6 max-w-4xl">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Categories</h2>
        <p class="text-gray-500 dark:text-gray-400 text-sm">{{ blogStore.categories.length }} categories</p>
      </div>
      <button
