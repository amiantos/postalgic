 ...
 * Matches the iOS app's template structure.
 */
...
{{/years}}`,
    ...
    'monthly-archive': `<h1>{{monthName}} {{year}}</h1>
...
<div class="tag-list">
    ...
    tag: `<h1>Posts tagged with "{{tagName}}"</h1>
...
{{/hasPagination}}`,
    ...
    categories: `<h1>All Categories</h1>
<div class="archive-separator"></div>
<div class="category-list">
    ...
    category: `<h1>Posts in category "{{categoryName}}"</h1>
{{#hasDescription}}<p class="category-description">{{description}}</p>{{/hasDescription}}
...
<rss version="2.0">
    <channel>
        ...
        {{#blogAuthor}}
        <managingEditor>{{#blogAuthorEmail}}{{blogAuthorEmail}} ({{blogAuthor}}){{/blogAuthorEmail}}{{^blogAuthorEmail}}{{blogAuthor}}{{/blogAuthorEmail}}</managingEditor>
        {{/blogAuthor}}
